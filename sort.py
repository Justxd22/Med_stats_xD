...
sorted_surgeons = sort_arabic(surgeons)
sorted_assistants = sort_arabic(assistants)

import json
i = open('sorted_surgeons.json', 'w', encoding='utf-8')
json.dump(sorted_surgeons, i, ensure_ascii=False, indent=4)
i.close()
i = open('sorted_assistants.json', 'w', encoding='utf-8')
json.dump(sorted_assistants, i, ensure_ascii=False, indent=4)
i.close()